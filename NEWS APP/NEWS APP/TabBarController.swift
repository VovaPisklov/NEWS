...
final class TabBarController: UITabBarController {
    ...
    private func setupViewControllers() {
        ...
        viewControllers = [
            ...
            setupNavigationController(rootViewController: BusinessViewController(viewModel: BusinessViewModel()), title: "Bussines", image: UIImage(systemName: "briefcase") ?? UIImage.add),
